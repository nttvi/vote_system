                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" action="{{ route('post.home.login') }}" method="post">
                        ...
                        <div class="form-group text-center p-b-20">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" type="submit">Đăng nhập</button>
                            </div>
                        </div>
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Chưa có tài khoản? <a href="pages-login.html" class="text-info m-l-5"><b>Đăng ký</b></a>
                            </div>
                        </div>
                    </form>
                </div>
