			...
			<div class="force-full-screen full-screen dark" style="background-image: url('{{ asset('image/ken-1.jpg')}}');background-position: 100%; background-repeat: no-repeat; background-size: cover;">
				...
				<div class="container clearfix">
					<div class="slider-caption slider-caption-center">
						...
						<a data-animate="fadeInUp" data-delay="600" href="{{ Auth::guard('member')->check() ? route('get.home.getCreateBauChon') : route('get.home.login') }}" class="button button-border button-light button-rounded button-large noleftmargin nobottommargin d-none d-md-inline-block" style="margin-top: 30px;">Tạo cuộc bầu chọn</a>
					</div>
				</div>
