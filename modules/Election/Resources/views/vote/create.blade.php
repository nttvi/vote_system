            ...
            <div class="card-header bg-red">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{ route('get.edit.election',$election->id) }}" class="btn btn-info float-right m-r-5"><i class="fas fa-undo-alt"></i> Về trang chỉnh sửa</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                        ...
                                        <div class="p-t-20 row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Tên người bầu chọn</label>
                ...
                <div class="card">
                    <div class="card-header bg-red">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <a href="{{ route('get.create.object',$election->id) }}" class="btn btn-warning float-right">Thêm đối tượng bầu chọn</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header bg-red">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('get.create.voter',$election->id) }}" class="btn btn-warning float-right m-r-5">Thêm người bầu chọn</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
